...
A very flexible and customizable https://commons.openshift.org/sig/OpenshiftOperators.html[Operator] in Go developed using the https://github.com/operator-framework/operator-sdk[Operator SDK] to package, install, configure and manage an PostgreSQL database.
