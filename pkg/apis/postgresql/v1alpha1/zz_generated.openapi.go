	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Backup is the Schema for the backups API operator-sdk:gen-csv:customresourcedefinitions.resources=\"PersistentVolumeClaim,v1,\"A Kubernetes PersistentVolumeClaim\"\"",
				Type:        []string{"object"},
